...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.foxdeli.com/tracking';
    ...
    public static function toDebugReport()
    {
        ...
        $report .= '    The version of the OpenAPI document: 14.70.0' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://api.foxdeli.com/tracking",
                "description" => "Production API server for live data",
            ],
            [
                "url" => "https://api.sandbox.foxdeli.com/tracking",
     ...
     * @param array<string,string>|null $variables hash of variable and the corresponding value (optional)
    ...
    public function getHostFromSettings($index, $variables = null)
    {
        ...
        if($hostVariables !== [] && is_iterable($hostVariables)){
