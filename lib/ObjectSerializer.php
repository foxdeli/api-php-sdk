...
class ObjectSerializer
{
     ...
     *
     * @return object|array<int|string, mixed>|null a single or an array of $class instances
     */
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        ...
        if ($class === '\SplFileObject') {
            ...
            if (
                ...
                && !is_array($httpHeaders['Content-Disposition'])
        ...
        if (method_exists($class, 'getAllowableEnumValues')) {
            ...
            foreach ($instance::openAPITypes() as $property => $type) {
                ...
                if (!isset($instance::setters()[$property]) || !isset($data->{$instance::attributeMap()[$property]})) {
                    continue;
                }
