...
use Foxdeli\ApiPhpSdk\Model\ModelInterface;
...
class ObjectSerializer
{
     ...
     *
     * @param string|float|int|bool|\DateTime $value the value of the parameter
     *
     * @return string the header string
     */
     ...
     * @param string[]|string[][] $httpHeaders   HTTP headers
     *
     * @return object|mixed[]|null a single or an array of $class instances
     */
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        ...
        if ($class === '\DateTime') {
            ...
            if (!empty($data)) {
                try {
                    ...
                    if ($sanitizeTimestamp = self::sanitizeTimestamp($data)) {
                        return new \DateTime($sanitizeTimestamp);
                    }
                }
            }
            return null;
        ...
        if ($class === '\SplFileObject') {
            ...
            if (
                ...
                && is_string($httpHeaders['Content-Disposition'])
        ...
        if (method_exists($class, 'getAllowableEnumValues')) {
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
                $subclass = '\Foxdeli\ApiPhpSdk\Model\\' . $data->{$discriminator};
