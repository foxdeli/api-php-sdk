...
/**
 * ParcelStateUpdate Class Doc Comment
 *
 * @category Class
 * @package  Foxdeli\ApiPhpSdk
 * @author   OpenAPI Generator team
 ...
 */
class ParcelStateUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ParcelStateUpdate';
    ...
    protected static $openAPITypes = [
        'state' => '\Foxdeli\ApiPhpSdk\Model\DeliveryStateRequest',
        'occurred' => '\DateTime',
        'note' => 'string'
    ];
    ...
    */
     ...
     * Gets state
     *
     * @return \Foxdeli\ApiPhpSdk\Model\DeliveryStateRequest
     */
     ...
     * Sets state
     *
     * @param string|int|\Foxdeli\ApiPhpSdk\Model\DeliveryStateRequest $state state
     *
     * @return self
     */
     ...
     * Sets occurred
     *
     * @param \DateTime|null $occurred optional moment in time when this change happened. ISO 8601, format: YYYY-MM-DDThh:mm:ss.sssZ
     *
     * @return self
     */
     ...
     * Sets note
     *
     * @param string|null $note optional note describing the state change
     *
     * @return self
     */
