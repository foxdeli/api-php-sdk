    ...
    */
    ...
    public function setFrom($from)
    {
        ...
        if ((!preg_match("/\d\d:\d\d:\d\d/", ObjectSerializer::toString($from)))) {
            throw new \InvalidArgumentException("invalid value for \$from when calling OpeningHoursIntervalResponse., must conform to the pattern /\d\d:\d\d:\d\d/.");
        }
    ...
    public function setTo($to)
    {
        ...
        if ((!preg_match("/\d\d:\d\d:\d\d/", ObjectSerializer::toString($to)))) {
            throw new \InvalidArgumentException("invalid value for \$to when calling OpeningHoursIntervalResponse., must conform to the pattern /\d\d:\d\d:\d\d/.");
        }
