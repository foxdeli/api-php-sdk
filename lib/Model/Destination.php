...
class Destination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = [])
    {
        ...
        $this->setIfExists('parcel_shop', $data, null);
    }
    ...
    */
     ...
     * @return self
     */
    public function setParcelShop($parcel_shop)
    {
        if (is_null($parcel_shop)) {
            throw new \InvalidArgumentException('non-nullable parcel_shop cannot be null');
        }
