...
class TimelineItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id unique id of timeline item
     *
     * @return self
     */
     ...
     * Sets parcel_id
     *
     * @param string|null $parcel_id optional identifier of referenced parcel. if this timeline item doesn't reference parcel, value is null
     *
     * @return self
     */
     ...
     * Sets text
     *
     * @param string|null $text Text of timeline item
     *
     * @return self
     */
     ...
     * Sets created
     *
     * @param \DateTime|null $created moment in time when timeline item has been created
     *
     * @return self
     */
     ...
     * Sets author
     *
     * @param string|null $author author of timeline item
     *
     * @return self
     */
