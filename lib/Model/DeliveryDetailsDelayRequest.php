...
/**
 * DeliveryDetailsDelayRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class DeliveryDetailsDelayRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeliveryDetailsDelayRequest';
    ...
    {
        $this->container['delayed'] = $data['delayed'] ?? null;
     ...
     * Sets delayed
     *
     * @param bool|null $delayed If delivery is delayed
     *
     * @return self
     */
    public function setDelayed($delayed) : self
    {
     ...
     * Sets reason
     *
     * @param string|null $reason The reason for the delay
     *
     * @return self
     */
