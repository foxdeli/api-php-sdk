...
class PaymentUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentUpdateRequest';
    ...
    */
     ...
     * Sets paid
     *
     * @param bool|null $paid state of payment. if not provided, existing state of payment assigned to order will remain unchanged. DEPRECATION NOTICE: marked for removal, use `state` instead
     *
     * @return self
     * @deprecated
     */
     ...
     * Sets link
     *
     * @param string|null $link payment link. if not provided, existing payment link assigned to order will remain unchanged
     *
     * @return self
     */
