...
class PickupPlaceResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets storage_time
     *
     * @param int|null $storage_time How long the shipment will be stored, in days. Deprecated in favor of storageTimeInDays.
     *
     * @return self
     * @deprecated
     */
     ...
     *
     * @param int|null $storage_time_in_days How many days will be the shipment stored
     *
     * @return self
     */
