...
class Product implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'description' => 'string',
        'availability' => '\Foxdeli\ApiPhpSdk\Model\ProductAvailabilityResponse',
        'url' => 'string',
        'image' => 'string',
    ...
    public function __construct(array $data = [])
    {
        ...
        $this->setIfExists('referenced_sku', $data, null);
    }
    ...
    */
     ...
     * Gets availability
     *
     * @return \Foxdeli\ApiPhpSdk\Model\ProductAvailabilityResponse|null
     */
     ...
     * Sets availability
     *
     * @param \Foxdeli\ApiPhpSdk\Model\ProductAvailabilityResponse|null $availability availability
     *
     * @return self
     */
     ...
     * Sets referenced_sku
     *
     * @param string|null $referenced_sku reference to the SKU of the product it belongs to, e.g. extended warranty. references product within same order
     *
     * @return self
     */
    public function setReferencedSku($referenced_sku)
    {
        if (is_null($referenced_sku)) {
            throw new \InvalidArgumentException('non-nullable referenced_sku cannot be null');
        }
