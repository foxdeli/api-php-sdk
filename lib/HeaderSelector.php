    ...
    */
    private function getAcceptHeaderWithAdjustedWeight(array $accept, array $headersWithJson): string
    {
        ...
        foreach ($accept as $header) {
            ...
            if (is_string($headerData['header']) && stripos($headerData['header'], 'application/json') === 0) {
     ...
     *
     * @return mixed[] with the header and its weight
    ...
    private function adjustWeight(array $headers, int &$currentWeight, bool $hasMoreThan28Headers): array
    {
        ...
        foreach ($headers as $index => $header) {
            ...
            /** @var string $headerHeader */
            $headerHeader = $header['header'];
            $acceptHeaders[] = $this->buildAcceptHeader($headerHeader, $weight);
        }
