...
final class UpdateParcelTest extends TestCase
{
    public function testWithValidAuthorization(): void
    {
        ...
        /** @var Parcel */
        $parcel = $tracking->updateParcel('33333333-3333-3333-3333-333333333333', "22222222-2222-2222-2222-222222222222", $this->getParcelUpdate());
    ...
    public function testWith400ResponsePaymentMethodInvalidValue(): void
    {
        ...
        if($parcelUpdate->getTracking()){
            ...
            $tracking->updateParcel('33333333-3333-3333-3333-333333333333', "22222222-2222-2222-2222-222222222222", $parcelUpdate);
        } else {
            $this->fail("External date not passed");
        }
    }
