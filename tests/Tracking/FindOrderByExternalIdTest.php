...
final class FindByExternalIdTest extends TestCase
{
    public function testWithValidAuthorization(): void
    {
        ...
        /** @var Order */
        $order = $tracking->findOrderByExternalId('ORD123456789', "00000000-0000-0000-0000-000000000000");
    ...
    private function getRawResponse() : string {
        return '{
            ...
            "links": {
                "trackAndTrace": {
                    "href": "https://tt.sandbox.foxdeli.com/order/55555555-5555-5555-5555-555555555555"
                }
            },
            "billingDetails": {
                "name": "John Doe",
    ...
    private function getRawError403Response() : string {
        return '{
            ...
            "status": 403,
            "detail": "Eshop with id 00000000-0000-0000-0000-000000000000 doesn\'t exist in this account.",
            "instance": "/tracking/api/v1/order",
            "eshopId": "00000000-0000-0000-0000-000000000000"
        }';
    }
    ...
    private function getRawError404Response() : string {
        return '{
            ...
            "status": 404,
            "detail": "Order with externalId ORD123456789 doesn\'t exist",
            "instance": "/tracking/api/v1/order",
            "resourceType": "Order",
            "resourceId": "ORD123456789",
