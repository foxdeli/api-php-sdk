...
final class UploadOrderProformaInvoiceTest extends TestCase
{
    public function testWithValidAuthorization(): void
    {
        ...
        /** @var FileInfo */
        $fileInfo = $tracking->uploadOrderProformaInvoice('22222222-2222-2222-2222-222222222222', __DIR__ . '/../foxdeli-intro.en-03-04-2023.pdf');
    ...
    public function testWith400Response(): void
    {
        ...
        $tracking->uploadOrderProformaInvoice('22222222-2222-2222-2222-222222222222', __DIR__ . '/../foxdeli-intro.en-03-04-2023.pdf');
    ...
    private function getRawError400Response(): string
    {
        return '{
            ...
            "status": 400,
            "detail": "uploadProformaInvoice.orderId: must be a valid UUID",
            "instance": "/tracking/api/v1/order/11111111-1111-1111-1111-111111111111/proforma-invoice",
            "violations": {
                "uploadProformaInvoice.orderId": "must be a valid UUID"
            }
        }';
    }
