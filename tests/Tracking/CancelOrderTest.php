...
final class CancelOrderTest extends TestCase
{
    ...
    public function testWith400Response(): void
    {
        ...
        $tracking->cancelOrder('22222222-2222-2222-2222-222222222222');
    ...
    public function testWith404Response(): void
    {
        ...
        $tracking->cancelOrder('11111111-1111-1111-1111-111111111111');
    ...
    private function getRawError403Response(): string
    {
        return '{
            ...
            "status": 403,
            "detail": "Account is not owner of resource ORDER with id 33333333-3333-3333-3333-333333333333",
            "instance": "/tracking/api/v1/order/33333333-3333-3333-3333-333333333333/cancel",
            "resourceType": "ORDER",
